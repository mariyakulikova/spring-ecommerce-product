package ecommerce.utiles

object Constants {
    const val ERR_NAME_UNIQUE = "Product name should be unique"
    const val ERR_NAME_NOT_BLANK = "Name must not be blank"
    const val ERR_PRICE_POSITIVE = "Price must be positive number"
